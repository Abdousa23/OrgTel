...
<div className='text-center relative flex justify-center items-center md:my-36'>
    ...
    <form onSubmit={handleSubmit}>
        ...
        type="email"
        id="email"
        className='my-2 mx-auto w-1/2 placeholder:text-black bg-slate-200 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1'
        value={email}
        placeholder='email'
