...
becomes a memorable experience</p>
    ...
    <div className="slider flex row overflow-hidden">
      <img src="/src/assets/Property 1=Default.png" className="m-auto w-3/4" alt="" />
    </div>
    ...
    <div className="container room bg-primary w-3/4 m-auto flex justify-start text-left items-start overflow-hidden">
        <div className="  my-8  flex flex-col justify-center items-center">
          ...
          <p className=" text-gray-500 w-1/2 m-8 ">Experience luxury at Syphax Hotel – where modern elegance
meets comfort in amazing rooms, your perfect sanctuary await</p>
    ...
    <div className="events m-auto container mb-16">
        <div className="event m-auto h-96 flex flex-col max-xm:flex-row justify-center items-stretch overflow-hidden flex-wrap">
          ...
          <div className="w-fit flex flex-col m-2 gap-1 ">
